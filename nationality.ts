...
export const Groups: Group[][] = [
  ...
  [
    ...
    { name: 'Silesian', colour: '#c900c9' } /* 23 */,
    { name: 'Albanian', colour: '#602020' } /* 24 */,
    { name: 'Austrian', colour: '#c70505' } /* 25 */,
    { name: 'Vietnamese', colour: '#004d13' } /* 26 */,
    { name: 'Korean', colour: 'N/A' } /* 27 */,
    { name: 'English', colour: '#f53d3d' } /* 28 */,
    { name: 'French', colour: '#5170fb' } /* 29 */,
    { name: 'Iranian', colour: 'N/A' } /* 30 */,
    { name: 'Irish', colour: '#38fa69' } /* 31 */,
